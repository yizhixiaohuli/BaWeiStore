...
public class DcommentFragment extends Fragment {
    private XRecyclerView document_xrv;
    private ArrayList<OrderList.OrderListBean> list;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_dcomment, null);
        initView(view);
        return view;
    }

    private void initView(View view) {
        document_xrv = (XRecyclerView) view.findViewById(R.id.document_xrv);
        getData();
    }
    ...
    private void getData() {
        ...
        document_xrv.setLayoutManager(new LinearLayoutManager(getActivity()));
        document_xrv.setAdapter(orderMadapter);

        String url="http://172.17.8.100/small/order/verify/v1/findOrderListByStatus?status=1&page=1&count=1";
